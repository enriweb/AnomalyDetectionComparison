...
combined_txt = "results/dinomaly2_combined.txt"
...
lines = []
lines.append("=" * 140)
lines.append(f"  Dinomaly2  (N={N_RUNS}, Encoder: dinov2reg_vit_base_14, dropout=0.2, depth=8, Context Recentering: True)")
