...
combined_txt = "results/edgenext_cfa_combined.txt"
CKPT_DIR = "results/EdgeNeXtCfa"
...
lines = []
lines.append("=" * 140)
lines.append(f"  EdgeNeXt-CFA  (N={N_RUNS}, Backbone: edgenext_small, Layers: [stages.1, stages.2, stages.3], γ_c=1, γ_d=1, K=3)")
