...
combined_txt = "results/repvit_efficientad_combined.txt"
CKPT_DIR = "results/RepViTEfficientAd"
...
lines = []
lines.append("=" * 140)
lines.append(f"  RepViT-EfficientAD  (N={N_RUNS}, Teacher: repvit_m1, Student: repvit_m0_9)")
