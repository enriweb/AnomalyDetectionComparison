...
csv_path = "results/fastvit_patchcore_results.csv"
combined_txt = "results/fastvit_patchcore_combined.txt"
...
lines = []
lines.append("=" * 140)
lines.append(f"  FastViT-PatchCore  (N={N_RUNS}, Backbone: fastvit_sa12, Layers: [stages.2, stages.3], Coreset: 25%)")
