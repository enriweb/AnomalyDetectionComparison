...
Metrics recorded per run:
    ...
    Efficiency — n_params (CNN + ViT combined), FLOPs (CNN branch), peak GPU MB,
...
combined_txt = "results/hybridcore_combined.txt"
CKPT_DIR = "results/HybridCore"
...
lines = []
lines.append("=" * 140)
lines.append(f"  HybridCore  (N={N_RUNS}, CNN: wide_resnet50_2 [layer2, layer3], ViT: deit_tiny_patch16_224, Coreset: 25%)")
